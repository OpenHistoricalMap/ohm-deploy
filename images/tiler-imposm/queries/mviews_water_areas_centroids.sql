...
DROP FUNCTION IF EXISTS create_water_areas_centroid_mviews;
CREATE OR REPLACE FUNCTION create_water_areas_centroid_mviews(
    source_table TEXT,
    view_name TEXT
)
RETURNS void AS $$
...
SELECT create_water_areas_centroid_mviews('osm_water_areas_z0_2', 'mview_water_areas_centroid_z0_2');
SELECT create_water_areas_centroid_mviews('osm_water_areas_z3_5', 'mview_water_areas_centroid_z3_5');
SELECT create_water_areas_centroid_mviews('osm_water_areas_z6_7', 'mview_water_areas_centroid_z6_7');
SELECT create_water_areas_centroid_mviews('osm_water_areas_z8_9', 'mview_water_areas_centroid_z8_9');
SELECT create_water_areas_centroid_mviews('osm_water_areas_z10_12', 'mview_water_areas_centroid_z10_12');
SELECT create_water_areas_centroid_mviews('osm_water_areas_z13_15', 'mview_water_areas_centroid_z13_15');
