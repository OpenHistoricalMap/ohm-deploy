...
SELECT create_centroids_mview('mv_landuse_areas_z3_5', 'mv_landuse_points_centroids_z3_5', NULL);
...
SELECT create_centroids_mview('mv_landuse_areas_z6_7', 'mv_landuse_points_centroids_z6_7', NULL);
...
SELECT create_centroids_mview('mv_landuse_areas_z8_9', 'mv_landuse_points_centroids_z8_9', NULL);

-- ============================================================================
-- Zoom 10-11: Medium-low simplification (15m), medium areas (>50K m² = 0.05 km²)
-- ============================================================================
SELECT create_simplified_mview('osm_landuse_areas', 'mv_landuse_areas_z10_11', 15, 50000, 'id, osm_id, type');
SELECT create_centroids_mview('mv_landuse_areas_z10_11', 'mv_landuse_points_centroids_z10_11', NULL);
...
-- ============================================================================
SELECT create_simplified_mview('osm_landuse_areas', 'mv_landuse_areas_z14_15', 5, 5000, 'id, osm_id, type');
SELECT create_centroids_mview('mv_landuse_areas_z14_15', 'mv_landuse_points_centroids_z14_15', 'mv_landuse_points');
...
SELECT create_centroids_mview('mv_landuse_areas_z16_20', 'mv_landuse_points_centroids_z16_20', 'mv_landuse_points');
