...
SELECT prepare_points_mview('osm_transport_points', 'mv_transport_points');
...
SELECT create_centroids_mview('mv_transport_areas_z10_11', 'mv_transport_points_centroids_z10_11', NULL);
SELECT create_centroids_mview('mv_transport_areas_z12_20', 'mv_transport_points_centroids_z12_20', 'mv_transport_points');
